...
class AccentsDictionary:
    def __init__(self, addon_path, counterDict, potentialToKihonkei, adjustedDict, conditionalYomi, readingOnlyDict,
                 exceptionDict, sameYomiDifferentAccent, suffixDict):
    ...
    def initSearch(self, word, prevW=False, nextW=False, getAudio=False, getGraph=False, wordType=False,
                   specifiedReading=False):
