...
class MILanguageModels():
    def __init__(self, mw):
        self.activeFields = [
            ...
            "coloredkanjireading;all;Togu Japanese Sentence;Standard;Sentence;back",
            "coloredkanjireading;all;Togu Japanese Sentence;Standard;Target Word;back",
            "coloredkanjireading;all;Togu Japanese Sentence;Standard;Definitions;back",

            "coloredhover;all;Togu Japanese Vocabulary;Standard;Target Word;front",
            "coloredkanjireading;all;Togu Japanese Vocabulary;Standard;Target Word;back",
            "coloredkanjireading;all;Togu Japanese Vocabulary;Standard;Definitions;back",
            "coloredkanjireading;all;Togu Japanese Vocabulary;Standard;Sentence;back",

            "coloredkanjireading;all;Togu Japanese Audio Vocabulary;Standard;Target Word;back",
            "coloredkanjireading;all;Togu Japanese Audio Vocabulary;Standard;Definitions;back",
            "coloredkanjireading;all;Togu Japanese Audio Vocabulary;Standard;Sentence;back",

            "coloredkanjireading;all;Togu Japanese Audio Sentence;Standard;Target Word;back",
            "coloredkanjireading;all;Togu Japanese Audio Sentence;Standard;Definitions;back",
            "coloredkanjireading;all;Togu Japanese Audio Sentence;Standard;Sentence;back"
        ]
        self.svg = '''
   <svg class="togu-logo" width="30" height="39" viewBox="0 0 30 39">
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
...
@media (min-width: 500px) {
  .togu-card--back .togu-card-content {
    display: grid;
    grid-gap: 10px;
    grid-template-areas:
  ...
  .toguEditorInput[style]{
    max-width: 570px !important;
  }

  .toguEditorInput[data-field="Definitions"][style]{
    font-size:18px !important;
  }

  .toguEditorInput[data-field="Sentence"][style]{
    font-size: 25px !important;
    max-width: 500px !important;
  }

  .toguEditorInput[data-field="Target Word"][style]{
    font-size: 24px !important;
    max-width: 500px !important;
  }


  .togu-card--back .togu-word-audio {
  ...
  .togu-card--back .togu-word-back {
    grid-area: word;
    text-align: left;
  }

  .togu-card--back .togu-sentence-audio {
  ...
  .togu-card--back .togu-sentence {
    grid-area: sentence;
  }

  .togu-card--back .togu-translation {
    grid-area: translation;
  }

  .togu-card--back .togu-definition {
    grid-area: definition;
  }
}
...
.ankidroid_dark_mode .togu-header,
.nightMode .togu-header {
  background: #f9a746;
  box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);
}

.ankidroid_dark_mode .togu-header h1,
.ankidroid_dark_mode .togu-header h1 {
  color: white;
}

.ankidroid_dark_mode .togu-card,
.nightMode .togu-card {
  position: relative;
  background: #363c4a;
...
"""
    ...
    def getModelList(self):
        modelList = []
        name = 'Togu Japanese Sentence'
        fields = ['Sentence', 'Translation', 'Target Word', 'Definitions', 'Image', 'Sentence Audio', 'Word Audio']
        front = '''<div class="togu-header">
%s
</div>
<div class="togu-card togu-card--front">
    <div class="togu-card-content">
        <span class="togu-word-front">{{Sentence}}</span>
    </div>
</div>
'''
        back = '''<div class="togu-header">
%s
</div>
<div class="togu-card togu-card--back">
    <div class="togu-card-image">
        {{Image}}
    </div>
    <div class="togu-card-content">
        <div class="togu-word-back">{{Target Word}}</div>
        <div class="togu-word-audio">{{Word Audio}}</div>
        <div class="togu-sentence">{{Sentence}}</div>
        <div class="togu-sentence-audio">{{Sentence Audio}}</div>
        <div class="togu-translation ">{{Translation}}</div>
        <div class="togu-definition">{{Definitions}}</div>
    </div>
</div>
'''
        modelList.append([name, fields, front % self.svg, back % self.svg])
        name = 'Togu Japanese Vocabulary'
...
<div class="togu-card togu-card--front">
    <div class="togu-card-content">
        <span class="togu-word-front">{{Target Word}}</span>
    </div>
</div>
'''

        modelList.append([name, fields, front % self.svg, back % self.svg])
        name = 'Togu Japanese Audio Sentence'
...
<div class="togu-card togu-card--front">
    <div class="togu-card-content">
        <span class="togu-word-front">{{Sentence Audio}}</span>
    </div>
</div>
'''

        modelList.append([name, fields, front % self.svg, back % self.svg])
        name = 'Togu Japanese Audio Vocabulary'
...
<div class="togu-card togu-card--front">
    <div class="togu-card-content">
        <span class="togu-word-front">{{Word Audio}}</span>
    </div>
</div>
'''
        ...
        if config:
            for model in self.modelList:
                if not self.mw.col.models.by_name(model[0]):
                    if config.get('AddToguJapaneseTemplate', False) == "on":
                        self.addModel(model)
    ...
    def addExportTemplates(self):
        ...
        for addon in addons:
            ...
            if dirName in ["Togu Dictionary", "1655992655"]:
    ...
    def addExportTemplatesToConfig(self, dirName):
        ...
        templates = {
            "Japanese Sentence": {
                "noteType": "Togu Japanese Sentence",
                "sentence": "Sentence",
            ...
            "Japanese Vocabulary": {
                "noteType": "Togu Japanese Vocabulary",
                "sentence": "Sentence",
                "secondary": "Translation",
                "notes": "Definitions",
                "word": "Target Word",
            ...
            "Japanese Audio Sentence": {
                "noteType": "Togu Japanese Audio Sentence",
                "sentence": "Sentence",
                "secondary": "Translation",
                "notes": "Definitions",
                "word": "Target Word",
            ...
            "Japanese Audio Vocabulary": {
                "noteType": "Togu Japanese Audio Vocabulary",
                "sentence": "Sentence",
                "secondary": "Translation",
                "notes": "Definitions",
                "word": "Target Word",
